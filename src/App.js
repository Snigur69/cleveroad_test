        ...
        <div className="StoreApp">
            <Router>
                ...
                <Switch>
                    ...
                    <Route path="/">
                        <Products productsTrigger={productsTrigger} openModal={openModal} removeProduct={removeProduct}/>
                    </Route>
                </Switch>
            </Router>
            {modal && (
                currentProduct ? (
                    <ManageProduct submitForm={editProductById} id={currentProduct} closeModal={closeModal} type="EDIT" />
                ) : (
                    <ManageProduct submitForm={pushProduct} closeModal={closeModal} type="ADD" />
                )
            )}
        </div>
    );
